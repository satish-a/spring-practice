...
Ext.onReady(function() 
{
	...
	var userDetailsForm = Ext.create('Ext.form.Panel',
	{
		...
		defaults: { anchor: '100%' }, url : '<c:url value="/vendor/add" />',
		items : 
		[
				...
				[ 
					{	columnWidth:.5, border:false, layout: 'anchor', defaultType: 'textfield',
						...
						[
							...
							{ fieldLabel: 'Account Type', name : 'accountType', anchor:'95%', value: 'Vendor', readOnly: true}
						]
					},
					{ 	columnWidth:.5, border:false, layout: 'anchor', defaultType: 'textfield',
						items: 
		...
		[
			...
			{ text : 'Cancel', handler: function() { window.location = "<c:url value="/vendor"/>" ;} } 
		]
	});
	...
	function userDetailsSubmit()
	{
		userDetailsForm.getForm().submit(
		{
			...
			{
				window.location = "<c:url value="/vendor"/>" ;
			},
